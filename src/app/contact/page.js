    ...
    <>
      ...
      <section className="h-screen bg-custom-green">
        <div className="w-full h-full pt-[140px] pb-5 place-items-end">
          <div className="bg-white w-full sm:w-[90%] md:w-[80%] lg:w-[70%] xl:w-[68%] h-full rounded-tl-[50px] right-0 relative flex items-center">
            <p className="px-10 sm:px-5 md:px-10 lg:px-20 xl:px-36 text-custom-green text-[18px] sm:text-[16px] md:text-[18px] lg:text-[22px] xl:text-[25px] font-semibold text-justify mt-20 absolute">
        ...
        <div className="text-[50px] sm:text-[60px] md:text-[90px] lg:text-[100px] xl:text-[120px] flex absolute font-bold left-[80px] lg:top-[160px] lg:gap-8 flex-col lg:flex-row top-[110px] gap-2 md:top[30px]">
      ...
      <section className="items-center mx-auto text-center bg-white py-[50px] sm:py-[30px] md:py-[50px] lg:py-[70px] xl:py-[100px] h-[750px] mb-72 lg:mb-0">
        <h1 className="font-thinbold text-[20px] sm:text-[16px] md:text-[18px] lg:text-[20px] xl:text-[20px] mb-10 w-full sm:w-[90%] md:w-[80%] lg:w-[70%] xl:w-[60%] text-left text-custom-green pl-10 sm:pl-5 md:pl-10 lg:pl-20 xl:pl-52">
